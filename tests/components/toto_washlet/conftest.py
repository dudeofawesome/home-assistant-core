"""Common fixtures for the TOTO Washlet tests."""
...
from homeassistant.components.toto_washlet import PLATFORMS
...
def mock_config_entry() -> MockConfigEntry:
    ...
    return MockConfigEntry(
        ...
        title="TOTO Washlet via Test IR transmitter",
        data={CONF_INFRARED_ENTITY_ID: MOCK_INFRARED_ENTITY_ID},
        unique_id=f"toto_washlet_{MOCK_INFRARED_ENTITY_ID}",
    )
...
async def init_integration(
    ...
    """Set up the TOTO Washlet integration for testing."""
    ...
    with patch("homeassistant.components.toto_washlet.PLATFORMS", platforms):
...
def mock_setup_entry() -> Generator[None]:
    ...
    with patch(
        "homeassistant.components.toto_washlet.async_setup_entry",
        return_value=True,
    ):
        yield
